...
export const services: ReadonlyArray<ServiceItem> = [
  {
    ...
    image: "/portfolio/montagem-trelica.jpg",
    href: "/estruturas",
    icon: "Grid3x3",
  },
  {
    ...
    image: "/portfolio/painel-led-evento.jpg",
    href: "/painel-de-led",
    icon: "Monitor",
  },
  {
  ...
  },
  {
    ...
    image: "/portfolio/palco-mg-locacoes.jpg",
    href: "/palco",
  ...
  },
  {
    ...
    image: "/portfolio/totem-led-mg.jpg",
    href: "/totem-de-led",
    icon: "Smartphone",
  },
  {
    id: "estrutura-individual",
    title: "Estrutura Completa",
    description: "Solução completa de estrutura para eventos: grid, torres, portais e cenografia com montagem e desmontagem especializada.",
    image: "/portfolio/estrutura-q25.jpeg",
    href: "/estrutura",
    icon: "Building2",
  },
];
...
export const portfolioItems: ReadonlyArray<PortfolioItem> = [
  { id: "1", title: "Montagem de Treliça Corporativa", category: "Estruturas", image: "/portfolio/montagem-trelica.jpg" },
  { id: "2", title: "Palco com Painel LED", category: "Painel LED", image: "/portfolio/palco-led-mg.jpg" },
  { id: "3", title: "Evento com Painel de LED Imersivo", category: "Painel LED", image: "/portfolio/painel-led-evento.jpg" },
  { id: "4", title: "Palco MG Locações", category: "Palco", image: "/portfolio/palco-mg-locacoes.jpg" },
  { id: "5", title: "Iluminação Profissional para Evento", category: "Iluminação", image: "/portfolio/iluminacao-profissional.jpg" },
  { id: "6", title: "Totens de LED MG", category: "Totem LED", image: "/portfolio/totem-led-mg.jpg" },
  { id: "7", title: "Estrutura Q25 em Montagem", category: "Estruturas", image: "/portfolio/estrutura-q25.jpeg" },
  { id: "8", title: "Estrutura Q30 Profissional", category: "Estruturas", image: "/portfolio/estrutura-q30.jpeg" },
];

export const companyInfo: CompanyInfo = {
  phone: "(11) 3858-0696",
  whatsapp: "5511938580696",
  email: "contato@mglocacoes.com.br",
...
export const heroContents: Record<string, HeroContent> = {
  home: {
    title: "SUA IDEIA,",
    highlight: "NOSSO COMPROMISSO",
    subtitle: "Produção completa para eventos corporativos de alto impacto. Transformamos visões em experiências memoráveis com tecnologia de ponta.",
  ...
  sobre: {
    ...
    ctaLink: "/servicos",
    backgroundImage: "/portfolio/montagem-trelica.jpg",
  },
  servicos: {
    title: "NOSSOS",
    highlight: "SERVIÇOS",
    ...
    ctaText: "Solicite um Orçamento",
    ctaLink: "/contato",
    backgroundImage: "/portfolio/palco-led-mg.jpg",
  },
  contato: {
    title: "ENTRE EM",
    highlight: "CONTATO",
    ...
    backgroundImage: "/portfolio/totem-led-mg.jpg",
  },
  estruturas: {
    title: "ESTRUTURAS",
  ...
  estrutura: {
    ...
    ctaText: "Solicite um Orçamento",
    ctaLink: "/contato",
    backgroundImage: "/portfolio/estrutura-q25.jpeg",
  },
  painelDeLed: {
    title: "PAINEL DE",
    highlight: "LED",
    ...
    ctaLink: "/contato",
    backgroundImage: "/portfolio/painel-led-evento.jpg",
  },
  iluminacao: {
    title: "ILUMINAÇÃO",
